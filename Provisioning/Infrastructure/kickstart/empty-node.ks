...
yum -y install net-tools bind-utils bridge-utils bash-completion kexec-tools policycoreutils-python
yum -y update

curl -o /root/firstboot.sh %%INSTALL_URL%%/firstboot/empty-node.fb
